...
if (!isset($role) || $role != 'hod') {
    header("Location: ../index.php");
    exit();
}

$controller = new FeedbackController($con);
$feedbacks = $controller->getFeedbacks($_SESSION['department']);
?>
                ...
                <tbody>
                    <?php foreach ($feedbacks as $feedback): ?>
                        <tr>
                            ...
                            <td>
                                <form action="../controllers/feedback_controller.php" method="POST" class="d-inline">
