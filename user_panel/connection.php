...
$q = "CREATE TABLE access_rights (
    id INT(11) AUTO_INCREMENT PRIMARY KEY,
    role_name VARCHAR(50),
    department VARCHAR(20),
    can_view_employees BOOLEAN DEFAULT 0,
    can_view_projects BOOLEAN DEFAULT 0,
    can_view_leaves BOOLEAN DEFAULT 0,
    can_view_salary BOOLEAN DEFAULT 0,
    can_view_tours BOOLEAN DEFAULT 0,
    can_edit_employees BOOLEAN DEFAULT 0,
    can_edit_projects BOOLEAN DEFAULT 0,
    can_edit_leaves BOOLEAN DEFAULT 0,
    can_edit_salary BOOLEAN DEFAULT 0,
    can_edit_tours BOOLEAN DEFAULT 0,
    created_by INT(11),
