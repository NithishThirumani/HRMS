...
<body id="page-top">
            ...
            <div class="row align-items-center">
                <div class="col-auto">
                    <div class="profile-pic-container">
                        ...
                        <img src="<?php echo !empty($row['profile_pic']) ? '../uploads/' . $row['profile_pic'] : '../uploads/profile_pics/default.jpg'; ?>"
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="department">
                                                <?php
                                                $departments = array(                       'Human Resources',
                                                    'Operations',
                                                    'Sales'
                                                );
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="visa_type">
                                                ...
                                                <option value="Employement Visa" <?php echo ($employee['visa_type'] == 'Employement Visa') ? 'selected' : ''; ?>>Employement Visa</option>
                                            ...
                                            <div class="document-preview">
                                                <?php if (!empty($employee['visa_doc'])): ?>
                                                    <div class="text-center">
                                                        ...
                                                        <?php else: ?>
                                                            <img src="https://san-solutions.in/emps/uploads/documents/<?php echo $employee['visa_doc']; ?>"
                                                                class="img-fluid rounded" style="max-height: 200px">
                                                        <?php endif; ?>
                                                        <p class="mt-2"><?php echo $employee['visa_doc']; ?></p>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                                ...
                                                <?php if (!empty($employee['passport_doc'])): ?>
                                                    <div class="text-center">
                                                        <?php if (pathinfo($employee['passport_doc'], PATHINFO_EXTENSION) == 'pdf'): ?>
                                                            <i class="far fa-file-pdf fa-3x text-danger"></i>
                                                        <?php else: ?>
                                                            <img src="https://san-solutions.in/emps/uploads/documents/<?php echo $employee['passport_doc']; ?>"
                                                                class="img-fluid rounded" style="max-height: 200px">
                                                        <?php endif; ?>
                                                        <p class="mt-2"><?php echo $employee['passport_doc']; ?></p>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            // Remove all other form submission handlers
            // Remove auto-save functionality
            // Keep only file upload previews and validations
        });
        ...
        $(document).ready(function () {
            ...
            function handleFileUpload(input, previewContainer) {
                ...
                if (!validTypes.includes(fileType)) {
                    Swal.fire({
                        ...
                        text: 'Please upload PDF or Image files only'
                    });
                    input.value = '';
                    return;
                }
            ...
            $('.doc-upload').change(function () {
                handleFileUpload(this, $(this).siblings('.document-preview'));
            });
            ...
            $('#employeeForm').validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            try {
                                // Remove JSON.parse() since we're already getting parsed JSON
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Error!',
                                    text: typeof error.message === 'object' ? JSON.stringify(error.message) : error.message
                                });
                            }
                        },
                        error: function (xhr, status, error) {
            ...
            $('.nav-link').on('click', function (e) {
                ...
                const currentInputs = currentTab.find('input[required]');

                if (currentInputs.length && !currentInputs.valid()) {
                    e.preventDefault();
                    Swal.fire({
                        icon: 'warning',
        ...
        // Add this to your existing document upload handler
        $('.doc-upload').change(function () {
            const file = this.files[0];
            if (!file) return;
            ...
            formData.append('employee_id', <?php echo $id; ?>);
            formData.append('document_type', $(this).attr('name').replace('_document', ''));
