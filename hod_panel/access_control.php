                        ...
                        <?php while ($role = mysqli_fetch_assoc($roles)): ?>
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $views = array();
                                    if ($role['can_view_employees'])
                                        $views[] = 'Employees';
                                    if ($role['can_view_projects'])
                                        $views[] = 'Projects';
                                    if ($role['can_view_leaves'])
                                        $views[] = 'Leaves';
                                    if ($role['can_view_salary'])
                                        $views[] = 'Salary';
                                    if ($role['can_view_tours'])
                                        $views[] = 'Tours';
                                    echo implode(', ', $views);
                                    ?>
                                </td>
                                <td>
                                    <?php
                                    $edits = array();
                                    if ($role['can_edit_employees'])
                                        $edits[] = 'Employees';
                                    if ($role['can_edit_projects'])
                                        $edits[] = 'Projects';
                                    if ($role['can_edit_leaves'])
                                        $edits[] = 'Leaves';
                                    if ($role['can_edit_salary'])
                                        $edits[] = 'Salary';
                                    if ($role['can_edit_tours'])
                                        $edits[] = 'Tours';
                                    echo implode(', ', $edits);
                                    ?>
                                </td>
                                <td>
                                    ...
                                    <a href="delete_role.php?id=<?php echo $role['id']; ?>" class="btn btn-sm btn-danger"
