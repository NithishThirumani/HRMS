...
<body id="page-top">
    ...
    <div class="container-fluid">
        <form id="registrationForm" action="add_clients.php" method="POST" enctype="multipart/form-data">
...
if (isset($_POST['btn'])) {
    ...
    if ($file_uploaded) {
        ...
        $q = "INSERT INTO guest_our_clients (title, img) VALUES ('$title', '$unique_filename')";
        
        if (mysqli_query($con, $q)) {
            echo "<script>alert('Form submitted successfully!');</script>";
            echo "<script>window.location.href='/emps/admin_panel/add_clients.php';</script>";
        } else {
...
?>
    ...
    <script src="js/Guest panel js/add_clients.js"></script>
