...
<body id="page-top">
    ...
    <div class="container-fluid">
        <form id="registrationForm" action="add_benefits.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
                <div class="wrapper wrapper--w680">
                    <div class="card card-1">
                        ...
                        <div class="card-body">
                            <h2 class="title">Benefits Form</h2>

                            <div>
                                <label>Title</label>
                                    <input class="input--style-1" value="<?php if(isset($_POST['title'])) echo $_POST['title']; ?>" type="text"
...
if(isset($_POST['btn'])) {
    ...
    $q = "INSERT INTO guest_benefits (title, para, icon) VALUES ('$title', '$para', '$icon')";
    if(mysqli_query($con, $q)) {
        echo "<script>alert('Form submitted successfully!');</script>";
        echo "<script>window.location.href='/emps/admin_panel/add_benefits.php';</script>";
    } else {
...
?>
    ...
    <script src="js/Guest panel js/add_benefits.js"></script>
