...
<div class="slip-number">
    ...
    Company Reg: 1090403
        ...
        <div class="payslip">
            <div class="header">
                <img src="img/logo.jpg" class="company-logo" style="height:75px;">
                                 <h5 style="font-size: 14px; font-family: Calibri, sans-serif; margin-bottom: 2px;">Communik Marketing Management Est</h5>
                 <div class="company-address" style="position: relative;">
        M-13, ACICO Business Park, Al Khabaisi, Port Saeed, Dubai, UAE.
        <div class="qr-code">
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=EMPID-' . $salary['eid'] . '-SAL-' . $salary['total_salary'] . '" style="width: 100%; height: 100%; object-fit: contain;">
        </div>
    </div>
        ...
        <tr>
            <td width="50%" style="vertical-align: top;">
                <table width="100%">
                     ...
                     <tr><td><strong>Labour ID No.:</strong> ' . $salary['labour_card_no'] . '</td></tr>
                     <tr><td><strong>Date of Joining:</strong> ' . date('d-m-Y', strtotime($salary['doj'])) . '</td></tr>
                     ' . (!in_array(strtolower(trim($salary['pay_mode'])), ['cash', 'cash memo']) ? '<tr><td><strong>Bank Name:</strong> ' . $salary['bank_name'] . '</td></tr>
            ...
            <td width="50%" style="vertical-align: top;">
                <table width="100%">
                    ...
                    <tr><td><strong>Visa Provider:</strong> ' . ($salary['vendor_visa_remarks'] ? $salary['vendor_visa_remarks'] : 'N/A') . '</td></tr>
    ...
    <div class="net-pay">
        Total Net Payable: AED ' . number_format($salary['total_salary'], 2) . '<br>
        ' . numberToWords($salary['total_salary']) . '
    </div>
