...
<body id="page-top">
    ...
    <div class="container-fluid">
        <form id="registrationForm" action="add_facts.php" method="POST">
                    ...
                    <div class="card card-1">
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div class="input-group1">
                                    <input class="input--style-1"
                                        value="<?php if(isset($_POST['number'])) echo $_POST['number']; ?>" type="number"
                                        placeholder="Enter a number" name="number" />
                                </div>
                            </div><br>
...
?>
    ...
    <script src="js/Guest panel js/add_facts.js"></script>
