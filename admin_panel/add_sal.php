...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        $total_salary = $net_payable;
               $pay_mode = isset($_POST['pay_mode']) ? $_POST['pay_mode'] : 'Cash Memo'; // Default pay mode
        ...
        payable_salary, deductions, total_salary, salary_date, pay_mode, vendor_visa_remarks
    ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");


        $insert_stmt->bind_param(
            "sdddddddddddddddssiddsss",  // 24 parameters
            $emp_id,
            $base_salary,
            $housing_allowance,
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.5" name="lto" class="form-control" value="0">
                                    </div>
            ...
            <select name="pay_mode" class="form-control">
                ...
                <option value="WPS">WPS</option>
                            ...
                            <tr>
                                <td colspan="3">
                                    <div class="form-group">
                                        <label class="form-label">Visa Provider</label>
                                        <textarea name="vendor_visa_remarks" class="form-control" rows="3" placeholder="Enter vendor visa related remarks..."></textarea>
                                    </div>
                                </td>
                            </tr>
                            <tr>
