...
$query = "SELECT id, eid, first_name, last_name, email, birthday, maritalsts, contact, address, country, 
    degree, start_from, end_to, Institute, status, doj, EmpLoc, EmpDiv, EmpGrade, role, department, 
    reporting_manager, emp_left_org, dol, EmpCostcenter, MOLID, bank_name, account_no, iban, nominee, 
    blood_group, gender, is_field_staff, visa_number, visa_type, visa_issue_date, visa_expiry_date, 
    passport_number, passport_type, passport_issue_date, passport_expiry_date, country_of_issue, 
    passport_issue_place, profile_pic, visa_doc, passport_doc FROM employees WHERE id = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $update_query = "UPDATE employees SET 
        ...
        status=?, doj=?, EmpLoc=?, EmpDiv=?, EmpGrade=?, role=?, department=?, 
                                ...
                                <table class="table">
                                        ...
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="date" name="birthday"
                                                    value="<?php echo htmlspecialchars($employee['birthday']); ?>">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group1">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="input-group1">
                                                <label>Address:</label>
                                                <textarea class="input--style-1"
                                                    name="address"><?php echo htmlspecialchars($employee['address']); ?></textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group1">
                                        ...
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="date" name="start_from"
                                                    value="<?php echo htmlspecialchars($employee['start_from']); ?>">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="date" name="end_to"
                                                    value="<?php echo htmlspecialchars($employee['end_to']); ?>">
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                        ...
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="date" name="doj"
                                                    value="<?php echo htmlspecialchars($employee['doj']); ?>">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="text" name="EmpLoc"
                                                    value="<?php echo htmlspecialchars($employee['EmpLoc']); ?>">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="text" name="EmpDiv"
                                                    value="<?php echo htmlspecialchars($employee['EmpDiv']); ?>">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="text" name="EmpGrade"
                                                    value="<?php echo htmlspecialchars($employee['EmpGrade']); ?>">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group1">
                                        ...
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="text" name="EmpCostcenter"
                                                    value="<?php echo htmlspecialchars($employee['EmpCostcenter']); ?>">
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="date" name="dol"
                                                    value="<?php echo htmlspecialchars($employee['dol']); ?>">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="text" name="visa_type"
                                                    value="<?php echo htmlspecialchars($employee['visa_type']); ?>">
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="date" name="visa_issue_date"
                                                    value="<?php echo htmlspecialchars($employee['visa_issue_date']); ?>">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="date" name="visa_expiry_date"
                                                    value="<?php echo htmlspecialchars($employee['visa_expiry_date']); ?>">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="text" name="passport_type"
                                                    value="<?php echo htmlspecialchars($employee['passport_type']); ?>">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="date" name="passport_issue_date"
                                                    value="<?php echo htmlspecialchars($employee['passport_issue_date']); ?>">
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="input-group1">
                                                ...
                                                <input class="input--style-1" type="date" name="passport_expiry_date"
                                                    value="<?php echo htmlspecialchars($employee['passport_expiry_date']); ?>">
                                            </div>
                                        </td>
