...
");
    ...
    if ($salary) {
        ...
        $qrData = 'EMPID-' . $salary['eid'] . '-SAL-' . $salary['total_salary'];
...
<div class="slip-number">
    ...
    Company Reg: 123456789
        ...
        <div class="payslip">
            <div class="header">
                <img src="img/logo.jpg" class="company-logo" style="height:30px;">
                <h5>Enhancing Productivity, Streamlining Processes</h5>
    ...
    <table class="employee-summary">
        <tr>
            <th colspan="2" style="background: #0ea5e9; color: white; padding: 8px;">Name & Particulars of Employee</th>
        </tr>
        <tr>
    ...
    <div class="signature">
        <table width="100%">
            <tr>
                ...
                <!--td width="34%"><img src="img/signas.jpg" width="100"></td-->
