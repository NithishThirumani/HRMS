...
<body id="page-top">
    ...
    <div class="container-fluid">
        <form id="registrationForm" action="add_slider.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
                <div class="wrapper wrapper--w680">
                    <div class="card card-1">
                        ...
                        <div class="card-body">
                            <h2 class="title">Image Slider form</h2>
...
if (isset($_POST['btn'])) {
    ...
    if ($file_uploaded) {
        ...
        $q = "INSERT INTO guest_slider_images (title, para, img) VALUES ('$title', '$para', '$unique_filename')";
        
        if (mysqli_query($con, $q)) {
            echo "<script>alert('Form submitted successfully!');</script>";
            echo "<script>window.location.href='/emps/admin_panel/add_slider.php';</script>";
        } else {
...
?>
    ...
    <script src="js/Guest panel js/add_slider.js"></script>
