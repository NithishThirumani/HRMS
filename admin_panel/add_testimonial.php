...
<body id="page-top">
    ...
    <div class="container-fluid">
        <form id="registrationForm" action="add_testimonial.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
                <div class="wrapper wrapper--w680">
                    <div class="card card-1">
                        ...
                        <div class="card-body">
                            <h2 class="title">Testimonial form</h2>

                            <div>
                                <p>Person Name</p>
                                <div class="input-group1">
                                    <input class="input--style-1"
                                        value="<?php if(isset($_POST['person'])) echo $_POST['person']; ?>" type="text"
                                        placeholder="Enter a person name" name="person" />
                                </div><br>
                            </div>
...
if (isset($_POST['btn'])) {
    ...
    if ($file_uploaded) {
        ...
        $q = "INSERT INTO guest_testimonial (person, para, position, img) VALUES ('$person', '$para',  '$position', '$unique_filename')";
        
        if (mysqli_query($con, $q)) {
            echo "<script>alert('Form submitted successfully!');</script>";
            echo "<script>window.location.href='/emps/admin_panel/add_testimonial.php';</script>";
        } else {
...
?>
    ...
    <script src="js/Guest panel js/add_testimonial.js"></script>
