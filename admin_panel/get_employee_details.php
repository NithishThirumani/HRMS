                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p><strong>Marital Status:</strong>
                                    <?php echo htmlspecialchars($employee['maritalsts'] ?? ''); ?></p>
                            </div>
                            <div class="col-md-6">
                                ...
                                <p><strong>Blood Group:</strong> <?php echo htmlspecialchars($employee['blood_group'] ?? ''); ?>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div id="employment" class="tab-pane fade">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p><strong>Department:</strong> <?php echo htmlspecialchars($employee['department_name']); ?>
                                </p>
                            ...
                            <div class="col-md-6">
                                ...
                                <p><strong>Reporting Manager:</strong>
                                    <?php echo htmlspecialchars($employee['reporting_manager']); ?></p>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="mt-3">
                                    ...
                                    <?php endif; ?>
                                    <?php if (isset($employee['medical_doc']) && $employee['medical_doc']): ?>
                                        <a href="<?php echo 'uploads/documents/' . basename($employee['medical_doc']); ?>"
                                            class="btn btn-sm btn-info m-1" target="_blank">
                                            <i class="fas fa-medkit mr-1"></i>Medical
                                        </a>
                                    <?php endif; ?>
                                </div>
                            </div>
