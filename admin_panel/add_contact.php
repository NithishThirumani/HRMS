...
<body id="page-top">
    ...
    <div class="container-fluid">
        <form id="registrationForm" action="add_contact.php" method="POST" enctype="multipart/form-data">
...
if(isset($_POST['btn'])) {
    ...
    $q = "INSERT INTO guest_contact (title, para, icon) VALUES ('$title', '$para', '$icon')";
    if(mysqli_query($con, $q)) {
        echo "<script>alert('Form submitted successfully!');</script>";
        echo "<script>window.location.href='/emps/admin_panel/add_contact.php';</script>";
    } else {
...
?>
    ...
    <script src="js/Guest panel js/add_contact.js"></script>
