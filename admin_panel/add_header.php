...
<body id="page-top">
    ...
    <div class="container-fluid">
        <form id="registrationForm" action="add_header.php" method="POST" enctype="multipart/form-data">
...
?>
    ...
    <script src="js/Guest panel js/add_header.js"></script>
