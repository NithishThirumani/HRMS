            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="document-details">
                        ...
                        <p><strong>Category:</strong> <?php echo ucfirst(htmlspecialchars($document['document_category'])); ?></p>
                        <p><strong>Type:</strong> <?php echo htmlspecialchars($document['document_type']); ?></p>
                        <p><strong>Upload Date:</strong> <?php echo date('d M Y', strtotime($document['upload_date'])); ?></p>
                        <?php if ($document['expiry_date']): ?>
                            <p><strong>Expiry Date:</strong> <?php echo date('d M Y', strtotime($document['expiry_date'])); ?></p>
                        <?php endif; ?>
