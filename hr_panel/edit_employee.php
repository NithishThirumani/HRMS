...
<body id="page-top">
    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-auto">
                    <div class="profile-pic-container">
                        <img src="<?php echo htmlspecialchars($pic); ?>" class="profile-pic"
                            id="profilePic"
                            data-original-src="<?php echo htmlspecialchars($pic); ?>"
                            alt="Profile Picture">
        ...
        <form id="employeeForm" action="process_employee_update.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="degree"
                                                value="<?php echo htmlspecialchars($employee['degree'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="Institute"
                                                value="<?php echo htmlspecialchars($employee['Institute'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="start_from"
                                                value="<?php echo htmlspecialchars($employee['start_from'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="end_to"
                                                value="<?php echo htmlspecialchars($employee['end_to'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    try {
                        ...
                        if (data.status === 'success') {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    window.location.href = 'view_emp1.php';
                                }
                            });
                        } else {
                        ...
                        Swal.fire({
                            title: 'Error!',
                            html: `Failed to update employee details<br><small>${error.message}</small>`,
                            icon: 'error',
                            confirmButtonText: 'OK'
                        });
                    }
                ...
                error: function(xhr, status, error) {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        html: `Failed to connect to server<br><small>${error}</small>`,
                        icon: 'error',
                        confirmButtonText: 'OK'
                    });
                }
        ...
        $('.doc-upload').on('change', function(e) {
            ...
            const preview = $(this).siblings('.document-preview');
            
            if (file) {
                const reader = new FileReader();
                reader.onload = function(e) {
                    if (file.type === 'application/pdf') {
                        preview.html('<div class="text-center"><i class="far fa-file-pdf fa-3x text-danger"></i><p class="mt-2">' + file.name + '</p></div>');
                    } else {
                        preview.html('<div class="text-center"><img src="' + e.target.result + '" class="img-fluid rounded" style="max-height: 200px"><p class="mt-2">' + file.name + '</p></div>');
                    }
                }
