                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                        ...
                        while ($row = mysqli_fetch_array($res)) { 
                            $firstLetter = strtoupper(substr($row['first_name'], 0, 1));
                            ?>
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><b><?php echo strtoupper($row['role']) . ' - ' . strtoupper($row['first_name']); ?></b></span>
