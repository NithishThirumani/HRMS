...
$query = "SELECT DISTINCT d.*, e.full_name as creator_name, w.status as approval_status, w.signed_at
...
<head>
    ...
    <title>Signed Documents - E-Signature Module</title>
    ...
    <div class="main-content">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">Signed Documents</h4>
            </div>
            <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-muted">
                                            <small>
                                                ...
                                                <i class="fas fa-clock"></i> Signed on: <?php echo date('M d, Y H:i', strtotime($doc['signed_at'])); ?><br>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="view.php?id=<?php echo $doc['id']; ?>" class="btn btn-primary btn-sm">
