            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                        ...
                        $q = "SELECT e.first_name, e.profile_pic, e.role 
                             FROM employees e 
                             JOIN emp_login el ON e.eid = el.emp_id 
                             WHERE e.user_name='$un'";
                        $res = mysqli_query($con, $q);
                        while ($row = mysqli_fetch_array($res)) { ?>
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><b><?php echo $row['role'] . ' - ' . $row['first_name']; ?></b></span>
                            <img class="img-profile rounded-circle" src="../img/Uploads/<?php echo $row['profile_pic']; ?>"><?php } ?>
                    </a>
