...
session_start();
if (!isset($_SESSION['admin_id']) && !isset($_SESSION['eid'])) {
    ...
    <section id="skills">
        <div class="container">
            ...
            <header class="section-header">
                ...
                <p>
                    At HR Matrix, our platform is crafted with precision and expertise, leveraging a robust set of
                    programming languages to ensure a seamless and powerful user experience. Our skilled development
                    team utilizes a variety of languages to bring you a feature-rich and reliable Employee Management System.
                </p>
            </header>
